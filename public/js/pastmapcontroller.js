angular.module("demo").controller("pastmapController",function($scope,$http, $rootScope){
    var map;
  ...
  $scope.generateGeo = function(location, radius) {
      ...
      var rd = radius / 10000; //about 111300 meters in one degree
      ...
      for( i = 0; i < data.length; i++ ) {
          ...
          google.maps.event.addListener(marker, 'click', (function(marker, i) {
              return function() {
                  ...
                  <div style='margin-bottom:20px;margin-top:30px;'><h5 class='center'><b>100% COMPLETE</b></h5></div>
                  </div>
                  <div class='col s6 m6 l6'>
                  ...
                  if(type=="Flight") {
                      ...
                      <div style='overflow:hidden'>
                      <div class='row'>
                      <div class='col s6 m6 l6' style="padding-top:30px;">
                      <a href="#/job-map/`+data[i].name+`" class='btn' style = 'background-color:`+data[i].color+`'>VIEW HIGHLIGHTS</a>
                      </div>
                      <div class='col s6 m6 l6'>
                      <div class='col s12 m12 l12'>
